function postMatchHistorynewai(oyuncu1, oyuncu2,name,score, player, ai) {
	$.ajax({
    ...
    postMatchHistoryTwoai(oyuncu1, oyuncu2,name ,player, ai);
}

function postMatchHistoryTwoai(oyuncu1, oyuncu2,name, player, ai) {
	$.ajax({
		url: '/addMatchHistory/',
		type: 'POST',
		data: {
...
function tournamentponggameai(oyuncu1,oyuncu2,name)
{
    // Global Variables
var DIRECTION = {
	IDLE: 0,
...
var Game = {
	...
	endGameMenu: function (text) {
		...
		postMatchHistorynewai(oyuncu1, oyuncu2 , name,scorenew, this.player.score, this.ai.score);
